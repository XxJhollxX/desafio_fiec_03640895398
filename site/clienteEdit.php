...
<?php 
    ...
    if(isset($_GET["cliente"])) {
        $cliente = $controller->buscarCliente($_GET["cliente"]);
...
<form class="mx-auto highlight" style="width:60%;" action="">
    <div class="form-row">
        <div class="form-group col-md-12">
            ...
            <input type="text" class="form-control" id="nome" placeholder="Nome" value=<?= $cliente->getNome(); ?>>
        </div>
    </div>
    <div class="form-row">
        <div class="form-group col-md-6">
            <label for="cpf">CPF</label>
            <input type="text" class="form-control" id="cpf" placeholder="cpf" value=<?= $cliente->getCPF(); ?>>
        </div>
        <div class="form-group col-md-6">
            <label for="Nascimento">Nascimento</label>
            <input type="text" class="form-control" id="Nascimento" placeholder="Nascimento" value=<?= $cliente->getDataNasc(); ?>>
        </div>
    </div>
    <hr class="separator">
    <?php 
